...
func TestCountFirstValidPassphrases(t *testing.T) {
	tests := []struct {
		name string
		ps []string
		want int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := CountFirstValidPassphrases(tt.ps); got != tt.want {
				t.Errorf("CountFirstValidPassphrases() = %v, want %v", got, tt.want)
			}
		})
	}
}