...
func TestGetMaxAllocated(t *testing.T) {
	type args struct {
		rawInput string
	}
	tests := []struct {
...
nm dec 907 if qen == 2233`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := GetMaxAllocated(tt.args.rawInput); got != tt.want {
				t.Errorf("GetMaxAllocated() = %v, want %v", got, tt.want)
			}
		})
	}
}
