...
func TestCalculateSecondOpcode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			CalculateSecondOpcode(0, tt.args.ints, tt.args.in, tt.args.out)
...
func TestRelativeBase(t *testing.T) {
	t.Run("first example", func(t *testing.T) {
		...
		CalculateSecondOpcode(0, ints, in, out)
	...
	t.Run("fourth example", func(t *testing.T) {
		...
		ints := []int{203, 0, 99}
		r := CalculateSecondOpcode(1000, ints, in, out)

		if r[1000] != 10 {
			t.Error("not matched", r[1000])
		}
	})
}
