...
func TestFindFirstDistanceToIntersectionPoint(t *testing.T) {
	type args struct {
		first  []string
		second []string
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FindFirstDistanceToIntersectionPoint(tt.args.first, tt.args.second); got != tt.want {
				t.Errorf("FindFirstDistanceToIntersectionPoint() = %v, want %v", got, tt.want)
			}
		})
	}
}
