...
func TestFindMultiplication(t *testing.T) {
	type args struct {
		numbers []int
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FindMultiplicationFor2(tt.args.numbers); got != tt.want {
				t.Errorf("FindMultiplicationFor2() = %v, want %v", got, tt.want)
			}
		})
	}
}
