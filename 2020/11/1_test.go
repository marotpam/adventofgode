...
func TestCountSeats1(t *testing.T) {
	type args struct {
		rawInput string
	}
	tests := []struct {
...
L.LLLLL.LL`,
			...
			name: "given example",
			args: args{
				rawInput: `LL.LL.LLLLLLLLLLLLLLLLLLL.LLLLLLLLLLLLLLL.LLLL.LLLLLLLL.LLLLLLLL.LLLLLLLLLLLLLLLLL.LLLLLLLL
...
LLLLLLLLLLLL.LLLLLL.LLLLL.LLLLLLL.LLLLLLLLLL.L.LLLLLLLL.LLLLLLLL.LLLLLLL.LLLLLLLLL.LLLLLLLL`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := CountSeats1(tt.args.rawInput); got != tt.want {
				t.Errorf("CountSeats1() = %v, want %v", got, tt.want)
			}
		})
	}
}